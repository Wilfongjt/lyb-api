...
const strategy =  function () {
  ...
  //console.log('process.env.JWT_ CLAIMS', process.env.JWT_ CLAIMS);
  //let claims = process.env.JWT_ CLAIMS; 
  let jwt_claims = {"aud":"lyttlebit-api", "iss":"lyttlebit", "sub":"client-api", "user":"guest", "scope":"api_guest", "key":"0"};

  //if (typeof(process.env.JWT_ CLAIMS) === 'string') {
  //  claims = JSON.parse(process.env.JWT_ CLAIMS);
  //}
  //console.log('process.env.JWT_ CLAIMS',process.env.JWT_ CLAIMS);
  //console.log('strategy typeof(claims)', typeof(claims));

  //console.log('strategy claims', claims);
  return {
...
exports.init = async () => {
  ...
  console.log('[* Start server for testng] 1');
