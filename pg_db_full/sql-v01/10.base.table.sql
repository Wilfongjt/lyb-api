...
ALTER DATABASE lyb_db SET "app.settings.jwt_secret" TO :postgres_jwt_secret;



-- doenst work ALTER DATABASE lyb_db SET "custom.authenticator_secret" TO 'mysecretpassword';
...
--ALTER DATABASE lyb_db SET "app.lb _env" To :lb _env;

-- SET: "app.postgres_jwt_claims" To :postgres_jwt_claims

ALTER DATABASE lyb_db SET "app.postgres_jwt_claims" To :postgres_jwt_claims;

ALTER DATABASE lyb_db SET "app.postgres_api_password" To :postgres_api_password;
